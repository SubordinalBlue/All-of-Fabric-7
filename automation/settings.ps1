...
$MODPACK_VERSION = "2.5.3"

# Last Version Of The Modpack
# Needed For Changelog Parsing
$LAST_MODPACK_VERSION = "2.5.2"
...
$CLIENT_FILE_DISPLAY_NAME = "All of Fabric 7 - $MODPACK_VERSION"
...
$SERVER_FILE_DISPLAY_NAME = "All of Fabric 7 Server - $MODPACK_VERSION"
